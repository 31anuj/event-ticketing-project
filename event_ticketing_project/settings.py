"""
Django settings for event_ticketing_project project.
...
SECRET_KEY = 'django-insecure-ay@bangm4$a1dcaew(!8!np*p$ywq6wu4or+&)zq1i4f0$2+v^'
...
ROOT_URLCONF = 'event_ticketing_project.urls'
...
WSGI_APPLICATION = 'event_ticketing_project.wsgi.application'
